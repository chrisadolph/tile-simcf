tilesetdefaults <- function(RxC=NULL,
    ...
    if (is.null(width$leftborder))
      width$leftborderNotGiven <- TRUE
    else
      width$leftborderNotGiven <- FALSE

     if (is.null(height$topborder))
      height$topborderNotGiven <- TRUE
    else
      height$topborderNotGiven <- FALSE

  
    if (is.null(output$wide)&&is.null(output$width))
      output$widthNotGiven <- TRUE
    else
      output$widthNotGiven <- FALSE
    ...
    width.def <- list(plot=1,
                      ...
                      xaxistitle=1,
                      topaxistitle=1,
                      yaxis.labelspace=0.5,
                      yaxis.rug=0.5,
                      rightaxis.labelspace=0.5,
                      rightaxis.rug=0.5,
                      maintitle=1,
                      undertitle=1,
                      plottitle=1,
    ...
    height.def <- list(plot=1,
                       ...
                       xaxistitle=2,     # 1.75
                       topaxistitle=2,   # 1.75
                       xaxis.labelspace=0.75,
                       xaxis.rug=0.5,
                       topaxis.labelspace=0.75,
                       topaxis.rug=0.5,
                       maintitle=3,       # 7
                       undertitle=1.5,    # 3
                       plottitle=1.5,   # 3, 1.5
                       columntitle=1.5, #1.5, 5.5
                       rowtitle=1.5, #1.5
                       yaxistitle=1,
                       rightaxistitle=1
                       )
